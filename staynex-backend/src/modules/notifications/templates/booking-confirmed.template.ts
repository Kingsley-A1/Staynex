...
export function renderBookingConfirmedEmail(input: BookingConfirmedEmailInput): RenderedEmail {
  ...
  return renderEmailLayout({
    subject: `Your Staynex Bookings booking is confirmed — ${input.propertyName}`,
    preheader: `Your booking at ${input.propertyName} is confirmed.`,
    heading: "Your stay is confirmed",
    intro: `${greeting(input.guestName)} Staynex Bookings has verified your payment and reserved your booking.`,
    ...
    textBody: ["Staynex Bookings has verified your payment and reserved your booking.", ...(input.voucherAttached ? ["Your verified Booking Confirmation & Receipt PDF is attached. Keep it, the reference, or its QR code available for check-in."] : [])],
    details: [
    ...
    reason: "You received this email because payment was verified and this booking was confirmed by Staynex Bookings.",
  });
}
