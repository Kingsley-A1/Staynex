...
export function renderPropertyApprovedEmail(input: PropertyApprovedEmailInput): RenderedEmail {
  ...
  return renderEmailLayout({
    subject: "Your Staynex Bookings property was approved",
    preheader: `${input.propertyName} was manually approved and is live.`,
    heading: "Your property was approved",
    intro: `${greeting(input.ownerName)} A Staynex Bookings administrator approved your property and its persisted status is now live.`,
    ...
    reason: "You received this email because an administrator approved your Staynex Bookings property.",
  });
}
