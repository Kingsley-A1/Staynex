...
export function renderPropertyRejectedEmail(input: PropertyRejectedEmailInput): RenderedEmail {
  ...
  return renderEmailLayout({
    subject: "Your Staynex property was not approved",
    preheader: `${input.propertyName} was not approved for publication.`,
    heading: "Your property was not approved",
    intro: `${greeting(input.ownerName)} A Staynex administrator rejected this property submission. It is not live.`,
    ...
    reason: "You received this email because an administrator rejected your Staynex property submission.",
  });
}
